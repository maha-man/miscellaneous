...
tFile = "arbeitszeit.txt"

if not os.path.exists(tFile):
    f = open(tFile, "w")
    f.write("\n")
    f.write("Arbeitszeit 1.0\n")
    f.write("Welcome to Arbeitszeit free software.\n")
    f.write("Arbeitszeit comes with ABSOLUTELY NO WARRANTY.\n")
...
layout = [[sg.Text("Arbeitszeit"), sg.Button("start"), sg.Button("stop"), sg.Button("calculate")]]
